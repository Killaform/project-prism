  ...
  useEffect(() => {
    const handleMessage = (event) => {
      if (event.data && event.data.type === 'GOOGLE_AUTH_SUCCESS') {
        ...
        console.error('Google OAuth error:', event.data.message);
        alert(event.data.message || 'Google login is not available at this time. Please use email/password login.');
      }
    };
